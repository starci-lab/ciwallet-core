...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            // Map node: scheme imports to browser-friendly polyfills
    ...
    plugins: [
        ...
        // Ensure node: scheme imports are rewritten for the browser bundle
        ...
        new webpack.DefinePlugin({
            "import.meta.env": JSON.stringify({
                ...
                VITE_COLYSEUS_URL: process.env.VITE_COLYSEUS_URL || "https://nomas-colyseus.kanibot.xyz"
            })
        })
    ],
    optimization: {
