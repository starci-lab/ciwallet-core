...
export const SelectTokenWithdraw = () => {
        ...
        <NomasCard className="bg-content3">
          <NomasCardBody>
            <SelectChainTab
              ...
              isSelected={(chainId) =>
                swapFormik.values.isInput
                  ? swapFormik.values.tokenInChainId === chainId
                  : swapFormik.values.tokenOutChainId === chainId
              }
              onSelect={(chainId) => {
              ...
              .map((token) => {
                return (
                  <TokenCard
                    ...
                    token={token}
                    chainId={
                      tokenManager.getChainIdByTokenId(token.tokenId) ??
                      ChainId.Monad
                    }
                  />
                );
