...
import { NomasAvatar, NomasCard, NomasCardBody, NomasSpinner } from "../../extends"
...
export const TokenCard2 = ({ token, chainId, onPress, isPressable = true }: TokenCard2Props) => {
    ...
    const { data, isLoading } = useSWR(
        ["potfolio-balance", token.address, network, token.address],
        async () => {
