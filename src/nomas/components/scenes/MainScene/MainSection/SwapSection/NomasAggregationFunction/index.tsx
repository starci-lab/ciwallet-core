...
import { NomasSpacer, NotFound } from "@/nomas/components"
        ...
        <>
            ...
            <NomasCardBody>
                ...
                <NomasCard variant={NomasCardVariant.Dark} isInner>
                    <NomasCardBody className={twMerge("gap-4 flex flex-col p-0", aggregations.length ? "p-4" : "")} scrollHeight={300} scrollable>
                        {
                            aggregations.length ? aggregations.map((aggregation) => {
                            ...
                            }) : <NotFound title="No aggregations found" />}
                    </NomasCardBody>
                </NomasCard>
            </NomasCardBody>
        </> 
