...
import { PerpSectionPage, selectSelectedAssetPrice, setPerpSectionPage, useAppDispatch, useAppSelector } from "@/nomas/redux"
        ...
        <NomasCard variant={NomasCardVariant.Dark} isInner>
            <NomasCardBody className="p-4">
                <div className="flex items-center justify-between">
                    <PressableMotion className="flex flex-row items-center gap-2" onClick={() => {
