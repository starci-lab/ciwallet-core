...
export const GamePositioning = {
    ...
    getFoodDropY(cameraHeight: number): number {
        return cameraHeight - GAME_LAYOUT.FOOD_GROUND_OFFSET - GAME_LAYOUT.FOOD_DROP_HEIGHT
    },
    ...
    getResponsivePetScale(cameraWidth: number): number {
        return Math.max(GAME_LAYOUT.PET_SCALE * this.getResponsiveScale(cameraWidth), 1.2)
    },

    // Get responsive food scale
    getResponsiveFoodScale(cameraWidth: number): number {
        return Math.max(GAME_LAYOUT.FOOD_SCALE * this.getResponsiveScale(cameraWidth), 1.2)
    },

    // Get responsive ball scale
    getResponsiveBallScale(cameraWidth: number): number {
        return Math.max(GAME_LAYOUT.BALL_SCALE * this.getResponsiveScale(cameraWidth), 1.2)
    },

    // Get responsive poop scale
    getResponsivePoopScale(cameraWidth: number): number {
        return Math.max(GAME_LAYOUT.POOP_SCALE * this.getResponsiveScale(cameraWidth), 1.2)
    },
