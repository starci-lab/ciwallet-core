...
import { GameRoomState } from "@/nomas/game/schema/ChatSchema"
...
export class ColyseusClient {
        ...
        if (message.success) {
            ...
            if (petManager) {
                ...
                if (activePet && activePet.cleanlinessSystem) {
                    activePet.cleanlinessSystem.createPoopAt(
    ...
    private handlePurchaseItemResponse(message: any) {
        ...
        // const { eventBus } = require("@/nomas/game/systems/PurchaseSystem")
