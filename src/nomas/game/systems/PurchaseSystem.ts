...
export class PurchaseSystem {
    ...
    private sendPurchaseRequest(purchaseId: string, request: PurchaseRequest): void {
    ...
    private handlePurchaseResponse(message: {
        ...
        const { purchaseId, success, message: responseMessage, currentTokens, itemData } = message
