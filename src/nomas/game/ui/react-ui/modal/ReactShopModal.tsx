...
export function ReactShopModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    const handleBuy = (item: ShopItem) => {
        ...
        if (category === "pets") {
            const petType = (item as PetItem).texture || (item as PetItem).species || item.name
    ...
    return (
        <ReactModalLayout onClose={onClose} showBalance={true} showEarnings={true} titleLogo={true}>
            {/* Tabs Section */}
                ...
                <div className="p-4">
                    {items.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">Items Coming Soon!</h3>
