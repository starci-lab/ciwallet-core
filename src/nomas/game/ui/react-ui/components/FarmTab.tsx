...
export function FarmTab({ activePets, selectedPet, setSelectedPet, onClose }: FarmTabProps) {
    const openShop = () => {
                ...
                <div>
                    ...
                    {activePets.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-8 text-center">
                            ...
                            <h3 className="text-base font-semibold text-white mb-1">No Pets Yet!</h3>
                            <p className="text-xs text-muted mb-4">Get your first pet from the shop</p>
                            <NomasButton onClick={openShop} className="bg-linear-to-r from-purple-500 to-pink-500">
                                🛒 Visit Shop
                            </NomasButton>
                        </div>
                    )}
